...
?>
<script>
nicIconPath="<?=$wPath?>nicedit/nicEditorIcons.gif";
</script>
<link href='<?=$wPath?>simplemde/simplemde.min.css' rel='stylesheet' type='text/css' />
<link href='<?=$wPath?>multiselect/bootstrap-multiselect.css' rel='stylesheet' type='text/css' />
...
<script src='<?=$wPath?>camera/script.js' type='text/javascript' language='javascript'></script>
